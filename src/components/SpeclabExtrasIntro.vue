<template>
  <div class="speclab-extras-intro-header-image text-light d-flex flex-column justify-content-end">
    <BContainer>
      <BRow>
...
<style>
.speclab-extras-intro-header-image {
  background-image:
    linear-gradient(0deg, rgb(66 42 22 / 100%) 0%, rgb(66 42 22 / 0%) 100%),
    url(/src/assets/colored_lights@2x.webp);
